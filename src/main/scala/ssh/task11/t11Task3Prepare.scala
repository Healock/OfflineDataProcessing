...
object t11Task3Prepare {
    def createDatabase(stmt: Statement, spark: SparkSession, prop: Properties, mysqlUrl: String): Unit = {
    ...
    def main(args: Array[String]): Unit = {
        ...
        createDatabase(stmt, spark, prop, mysqlUrl)
